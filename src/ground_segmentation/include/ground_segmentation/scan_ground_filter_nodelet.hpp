...
/// Simple vehicle info struct (replaces vehicle_info_util)
struct VehicleInfo
{
  float wheel_base_m = 2.7f;
  float vehicle_height_m = 1.5f;
};
...
private:
  void onPointCloud(const sensor_msgs::msg::PointCloud2::ConstSharedPtr input);
